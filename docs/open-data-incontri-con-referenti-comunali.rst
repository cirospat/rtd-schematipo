...
Il portale open data è disponibile al link \ |LINK8|\ . 

Il catalogo dei dataset è disponibile al link \ |LINK9|\ . 

Il feed RSS open data è disponibile al link \ |LINK10|\ .
...
Il \ |LINK11|\  alla presenza dei Dirigenti Capo Area, del Segretario Generale dott. Dall’Acqua, del webmaster dott. Meli, dell’esperto GIS arch. Cabasino.
...
referente tecnico open data: Vito Gaglio - \ |LINK12|\  - tel 091.7408541
...
2) ad inviarlo via email al Webmaster (\ |LINK14|\  - \ |LINK15|\ ) e per conoscenza al Responsabile Open Data ed alla UO Innovazione, Pubblicazione e Open Data (\ |LINK16|\ ).
...
Referenti: Caterina Tardibuono \ |LINK17|\  e Francesco Dragotto \ |LINK18|\  
...
E' stata analizzata la gamma più comune delle licenze della Creative Commons riconsociute a livello mondiale \ |LINK19|\ . Sono state tracciate le differenze tra le varie licenze, e si è riconosciuta la validità della CC BY SA in quanto è quella che tra le altre è  comparata con le licenze usate dai software opensource e gratuite "copyleft". 
...
Referenti: Giuseppe Dioguardi \ |LINK24|\  

Ing. Graziella Pitrolo \ |LINK25|\  
...
Ciro Spataro si è reso disponibile a costruire mappe tematiche sulla mobilità avvalendosi della  piattaforma open source UMAP \ |LINK27|\  una volta che avrà ricevuto, dalla stessa Area Pianificazione Urbanistica, i file con la posizione geografica di detti sistemi di mobilità.
...
Referenti: sig.ra Alba \ |LINK32|\  - sig. Ribbeni 
...
Referenti: Inzerillo \ |LINK33|\ , Baudo \ |LINK34|\ , Buttitta (Commissario PM) \ |LINK35|\  
...
Altresì nel primo quadrimestre 2015 si è svolto un \ |LINK36|\ .
...
Incontro con referente tematico, ALBERTO MANDALARI \ |LINK37|\  E CATERINA DI CARA \ |LINK38|\  
...
Incontro con referente M.Campagna \ |LINK39|\  e Archimede Santoro 
...
Incontro con referente Sabina Buccheri \ |LINK41|\  , tel 091.7409105

21 luglio 2015

L'Ufficio Sport e Impianti sportivi non utilizza applicativi gestionali per le attività di competenza. Ha invece un portale web tematico dedicato \ |LINK42|\   il cui aggiornamento è curato anche dalla referente open data, Sig.ra Buccheri.
...
* elenco delle assegnazioni stagionali degli spazi pubblici sportivi alle Società sportive che ne fanno richiesta, secondo un \ |LINK43|\ . Nel periodo di Luglio Agosto di ogni anno le Società sportive fanno richiesta all'Ufficio Sport per l'assegnazione di spazi pubblici sportivi e successivamente, nel rispetto del regolamento comunale si effettuano le assegnazioni;
...
Incontro con referente Mauro Costa \ |LINK44|\  

29 luglio 2015

La Biblioteca comunale di Casa Professa non utilizza applicativi gestionali a parte LIBRARSI \ |LINK45|\  che è un interfaccia web pubblica per la ricerca dei testi e delle opere disponibili in consultazione presso la sede della Biblioteca. Librarsi fa riferimento, per la catalogazione, a OPAC SBN CATALOGO NAZIONALE \ |LINK46|\  che è la piattaforma di catalogazione di tutte le biblioteche pubbliche d’Italia. Lo strumento di ricerca della piattaforma Librarsi consente di visualizzare i dati della catalogazione del testo in formato aperto (selezione UNIMARC).
...
L'arch. Emo illustra i dataset che vengono gestiti con il programma Geomedia, e che sono stati censiti nel mese di dicembre 2015 in un \ |LINK48|\ :
...
L'applicativo inoltre mette in diretta relazione la \ |LINK49|\  con i numeri civici permettendo, in questa maniera, una facile georeferenziazione.
...
A tal riguardo \ |LINK50|\  in merito all'evento e alla \ |LINK51|\ . Anche \ |LINK52|\  sulla loro esperienza di monitoraggio civico con gli open data.
...
* nel presente anno scolastico (2015-16) \ |STYLE31|\ . Uno ad aprile e uno a maggio. Gli eventi avrebbero l'obiettivo di tenere alta l'attenzione dei ragazzi sui dati aperti fornendo loro strumenti di lavoro:
    ...
    * Il primo su come costruire mappe georeferenziate partendo da un database (\ |LINK53|\  che ho scritto tempo fa, per i prof tecnologici);

    * il secondo evento di maggio  è possibile deciderlo insieme anche con i membri di \ |LINK54|\  che realizzano spesso eventi culturali di sensibilizzazione sugli open data.
...
Dall'8 al 10 aprile 2016 presso il padiglione 20 della Fiera del Mediterraneo di Palermo si è svolta la 5° edizione dello \ |LINK55|\  manifestazione patrocinata dal Comune di Palermo.
...
A questo \ |LINK56|\  il mentor comunale ha fornito ai gruppi delle startup i contenitori online di dati sul turismo che oggi possono essere consultati per costruire servizi in questo ambito specifico. 
...
In un incontro cooordinato dalla dott.ssa Romano sulla raccolta dei dati per la \ |LINK57|\ , a cui hanno partecipato dipendenti dell'ufficio Turismo, dell'Ufficio Centro Storico (Città Storica), Webmaster è stata condivisa l'importanza di aggiornare i dati in maniera tempestiva. 
...
Insieme ai docenti e agli studenti di una terza classe dell'IPS Einaudi, e Marco Alfano e Davide Taibi (CNR) della community \ |LINK72|\  si divulgano i concetti sull'importanza dei dati nella società al fine di effettuare scelte consapevoli nella vita quotidiana.
...
L'Area cura in maniera particolare la redazione del \ |LINK78|\  e del \ |LINK79|\ .
...
La versione 2015 del \ |LINK80|\ , diversamente dagli anni precedenti (in cui si produceva un corposo file pdf di centinaia di pagine) è costituita da diverse pagine web suddivise per tematismi, risultando così di agevole e semplice consultazione.

Il Controllo di Gestione, presenta una sua versione sintetica denominata "\ |LINK81|\ " caratterizzata dalla presenza di tabelle con importanti dati sui costi ed entrate dell'Amministrazione suddivise per le Aree amministrative. 
...
La comunità di \ |LINK82|\  si è incontrata dal 2 al 4 Settembre 2016 a Messina, ospitata nella sede della facoltà di Scienze Cognitive della locale Università, con un \ |LINK83|\  di tre giornate di confronto, workshop formativi ad accesso gratuito e gruppi di sviluppo progettuale per lavorare sugli Open Data.
...
Partecipazione ad un importante \ |LINK88|\  in cui ci si è confrontati, a livello nazionale, sulle redigende linee guida nazionali open data. Organizzato dal Formez e dal portale nazionale dei dati aperti \ |LINK89|\   
...
Nell'ambito delle attività legate alla valorizzazione del patrimonio informativo comunale, è stato costruito, insieme al gruppo di lavoro "Promozione e Comunicazione" della Biblioteca Comunale di Palermo, il profilo Flickr \ |LINK145|\  per la pubblicazione del patrimonio storico già digitalizzato.
...
.. |LINK10| raw:: html
    ...
    <a href="https://www.comune.palermo.it/feed/rss_opendata.xml" target="_blank">link al Feed RSS</a>
